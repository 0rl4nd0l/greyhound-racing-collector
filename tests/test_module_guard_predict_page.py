...
def test_predict_page_post_does_not_trigger_results_scraper(monkeypatch):
    ...
    sys.modules["src.collectors.the_greyhound_recorder_scraper"] = types.ModuleType(
        "src.collectors.the_greyhound_recorder_scraper"
    )
    ...
    resp = client.post(
        "/predict_page",
        data={"race_files": race_filename, "action": "single"},
...
def test_module_guard_blocks_when_results_scraper_loaded(monkeypatch):
    ...
    sys.modules["src.collectors.fasttrack_scraper"] = types.ModuleType(
    ...
    resp = client.post(
        "/predict_page", data={"race_files": race_filename}, follow_redirects=False
    )
...
def test_manual_prediction_flow_works_without_tgr_scraper(monkeypatch):
    ...
    resp = client.post(
        "/predict_page", data={"race_files": race_filename}, follow_redirects=True
    )
