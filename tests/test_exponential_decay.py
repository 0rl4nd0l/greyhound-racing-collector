...
class TestExponentialDecayWeighting(unittest.TestCase):
    ...
    def test_recent_form_decay_weighting(self):
        ...
        # Generate features
        good_features = self.feature_engineer._create_performance_features(recent_good_dog)
        poor_features = self.feature_engineer._create_performance_features(recent_poor_dog)
        consistent_features = self.feature_engineer._create_performance_features(consistent_dog)
        ...
        print(f"Recent good form - Simple mean: {simple_mean_good:.3f}, Decay weighted: {decay_weighted_good:.3f}")
        self.assertLess(decay_weighted_good, simple_mean_good, 
        ...
        print(f"Recent poor form - Simple mean: {simple_mean_poor:.3f}, Decay weighted: {decay_weighted_poor:.3f}")
        self.assertGreater(decay_weighted_poor, simple_mean_poor,
        ...
        print(f"Consistent form - Simple mean: {simple_mean_consistent:.3f}, Decay weighted: {decay_weighted_consistent:.3f}")
        self.assertAlmostEqual(decay_weighted_consistent, simple_mean_consistent, places=1,
    ...
    def test_time_history_decay_weighting(self):
        ...
        # Generate features
        fast_features = self.feature_engineer._create_performance_features(recent_fast_dog)
        slow_features = self.feature_engineer._create_performance_features(recent_slow_dog)
        ...
        print(f"Recent fast times - Simple mean: {simple_mean_fast:.3f}, Decay weighted: {decay_weighted_fast:.3f}")
        self.assertLess(decay_weighted_fast, simple_mean_fast,
        ...
        print(f"Recent slow times - Simple mean: {simple_mean_slow:.3f}, Decay weighted: {decay_weighted_slow:.3f}")
        self.assertGreater(decay_weighted_slow, simple_mean_slow,
    ...
    def test_traditional_analysis_decay_integration(self):
        ...
        recent_good_results = [
            (1, 28.0, 0.5, 3.0, "2025-01-08", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.0, 1),
            (2, 28.2, 1.0, 4.0, "2025-01-06", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.1, 2),
            (5, 30.0, 3.0, 8.0, "2024-12-20", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.2, 3),
            (6, 31.0, 4.0, 12.0, "2024-12-15", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.0, 4),
            (7, 32.0, 5.0, 15.0, "2024-12-10", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 29.8, 5),
        ]
        
        recent_poor_results = [
            (7, 32.0, 5.0, 15.0, "2025-01-08", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.0, 1),
            (6, 31.0, 4.0, 12.0, "2025-01-06", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.1, 2),
            (1, 28.0, 0.5, 3.0, "2024-12-20", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.2, 3),
            (2, 28.2, 1.0, 4.0, "2024-12-15", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 30.0, 4),
            (1, 28.1, 0.3, 2.5, "2024-12-10", "TEST", "500m", "Grade 5", "Good", "Test Trainer", 29.8, 5),
        ]
        
        # Process results through traditional analysis
        good_stats = self.traditional_analyzer._process_race_results(recent_good_results)
        poor_stats = self.traditional_analyzer._process_race_results(recent_poor_results)
        ...
        self.assertGreater(good_avg_position, poor_avg_position,
        ...
        self.assertGreater(good_recent_avg, poor_recent_avg,
    ...
    def test_decay_factor_strength(self):
        ...
        self.assertAlmostEqual(features["recent_form_avg"], expected_form_avg, places=3,
        ...
        self.assertGreater(decay_diff, 0.1,
    ...
    def test_decay_consistency_across_methods(self):
        ...
        dog_data = {
            "recent_form": test_positions,
            "time_history": test_times
        }
        ...
        # Verify consistency
        self.assertAlmostEqual(features["recent_form_avg"], expected_form, places=3,
                              msg="Feature engineer should use consistent decay calculation")
        self.assertAlmostEqual(features["avg_time"], expected_time, places=3,
...
def run_tests():
    ...
    # Create test suite
    test_suite = unittest.TestLoader().loadTestsFromTestCase(TestExponentialDecayWeighting)
