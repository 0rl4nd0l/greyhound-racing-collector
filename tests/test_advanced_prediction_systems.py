...
class AdvancedPredictionSystemsTest:
    ...
    def test_ml_system_v4(self):
        ...
        try:
            ...
            print("✅ ML System V4 core test PASSED")
    ...
    def test_prediction_pipeline_v4(self):
        ...
        try:
                ...
                try:
                    ...
                    if result.get("success"):
                        ...
                        if predictions:
                            ...
                            print(
                                f"   🏆 Top pick: {top_pick.get('dog_clean_name', 'Unknown')}"
                            )
                            print("   📈 Method: ML System V4")

                        self.test_results["performance_metrics"][
                            "pipeline_v4_prediction"
                        ] = {
                    ...
                    self.test_results["errors"].append(
                        f"Pipeline V4 prediction: {str(e)}"
                    )
            else:
            ...
            self.test_results["tests_passed"] += 1
            print("✅ Prediction Pipeline V4 test PASSED")
    ...
    def test_prediction_pipeline_v3(self):
        ...
        try:
            ...
            systems = {
                ...
                "comprehensive_pipeline": pipeline_v3.comprehensive_pipeline
                is not None,
            }
            ...
            if self.test_race_files:
                ...
                try:
                    start_pred_time = time.time()
                    result = pipeline_v3.predict_race_file(
                        test_file, enhancement_level="full"
                    )
                    pred_time = time.time() - start_pred_time
            ...
            self.test_results["tests_passed"] += 1
            print("✅ Prediction Pipeline V3 test PASSED")
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(
                                "❌ Temporal protection failed - leaky features not detected"
                            )
                            leakage_protected = False
                        except AssertionError as e:
                            if "TEMPORAL LEAKAGE DETECTED" in str(e):
                                print(
                                    "✅ Temporal leakage protection verified - correctly detected leaky features"
                                )
    ...
    def test_calibration_and_ev(self):
        ...
        try:
            ...
            print(
                f"{'✅' if calibration_available else '❌'} Calibrated pipeline: {calibration_available}"
            )

            # Test EV thresholds
            ev_configured = len(ml_v4.ev_thresholds) > 0
            print(
                f"{'✅' if ev_configured else '❌'} EV thresholds configured: {ev_configured}"
            )
    ...
    def test_data_quality(self):
        ...
        try:
            ...
            print(
                f"📋 Key tables present: {len(key_tables) - len(missing_tables)}/{len(key_tables)}"
            )
            ...
            print(
                f"📁 Race file quality: {valid_files}/{total_files} valid ({file_quality:.1%})"
            )
            ...
            if self.test_race_files:
                ...
                try:
                    ...
                    if result.get("success"):
                        ...
                        print(
                            f"🚀 Prediction speed: {pred_time:.2f}s for {len(predictions)} predictions"
                        )
                        print(
                            f"📈 Throughput: {pred_per_second:.1f} predictions/second"
                        )
