...
def test_batch_processing_integration():
    ...
    try:
        ...
        csv1 = create_test_csv("""Dog Name,PLC,BOX,DIST,DATE,TRACK,G
Fluffy,1,2,500,2024-01-01,TestTrack,5
,2,3,520,2024-01-02,TestTrack,5
Speedster,3,1,500,2024-01-01,TestTrack,5
""")
        
        csv2 = create_test_csv("""Dog Name,PLC,BOX,DIST,DATE,TRACK,G
...
""")
        ...
        ingestor = FormGuideCsvIngestor(db_path=test_db, validation_level=ValidationLevel.LENIENT)
        ...
        print(f"✅ Batch processing integration test passed: {race_count} races, {dog_count} dogs")
...
def test_batch_size_configuration():
    ...
    assert len(chunks) == 4, f"Expected 4 chunks with BATCH_SIZE={BATCH_SIZE}, got {len(chunks)}"
...
def test_executemany_usage():
    ...
    # Create test data
    test_data = [
        {'dog_name': 'TestDog1', 'track': 'TestTrack', 'date': '2024-01-01', 
         'distance': '500', 'grade': '5', 'place': '1', 'box': '1'},
        {'dog_name': 'TestDog2', 'track': 'TestTrack', 'date': '2024-01-01', 
         'distance': '500', 'grade': '5', 'place': '2', 'box': '2'}
    ]
...
def main():
    ...
    try:
        ...
        print("✅ Step 5: Batch-processing chunk loop implementation is working correctly")
