...
def test_refresh_list_get_and_check_contracts(client):
    ...
    try:
        ...
        assert 'categorical_columns' in contract and isinstance(contract['categorical_columns'], list)
        assert 'numerical_columns' in contract and isinstance(contract['numerical_columns'], list)
