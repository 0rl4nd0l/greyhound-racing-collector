    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print(f"⚠️ Leakage protection FAILED - post-race features not detected")
                return False
            except AssertionError as e:
                if "TEMPORAL LEAKAGE DETECTED" in str(e):
            ...
            try:
                ...
                print(f"⚠️ Odds protection FAILED - odds features not detected")
                return False
            except AssertionError as e:
                if "TEMPORAL LEAKAGE DETECTED" in str(e):
        ...
        try:
            ...
            features = builder.build_features_for_race(prediction_data, race_id + "_features")
