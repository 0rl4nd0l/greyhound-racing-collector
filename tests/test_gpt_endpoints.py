...
def test_gpt_enhance_race_openai_failure(mock_get_enhancer, client):
    ...
    data = {"race_file_path": "test_race.csv", "include_betting_strategy": True}
...
@patch("app.get_gpt_enhancer")
def test_gpt_enhance_multiple_races_missing_list(
    mock_get_enhancer, mock_gpt_enhancer, client
):
