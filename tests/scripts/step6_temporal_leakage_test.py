...
def test_temporal_leakage_guard():
    ...
    if not result.get('success', True):
        ...
        if "TEMPORAL LEAKAGE DETECTED" in error_message and "is in the future" in error_message:
        ...
        print("❌ FAIL: Prediction succeeded for future race (temporal leakage not detected)")
