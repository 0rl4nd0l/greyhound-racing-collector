...
from config_loader import ConfigLoader, get_config, get_config_loader
...
def main():
    ...
    def make_prediction_with_config():
        ...
        print(
            f"Making prediction with min_confidence={min_conf}, max_calibration_error={max_cal_error}"
        )
