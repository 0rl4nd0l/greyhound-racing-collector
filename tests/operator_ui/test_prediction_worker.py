...
def ready(job):
    ...
    return canonical_bytes({"schema_version":"on_demand_race_prediction_v2","prediction_id":"12345678-1234-4123-8123-123456789abc","job_id":job.job_id,"generated_at":"2026-08-01T00:00:01+00:00","status":"PREDICTION_READY","blocker_stage":None,"blocker":None,"research_only":True,"production_persisted":False,"betting_output":False,"race":{**RACE,"venue_slug":"richmond","race_id":RACE_ID,"jump_timestamp":"2026-08-01T01:00:00+00:00"},"model":{"requested":"latest-research","resolved":"market_form_residual_v1","alias_resolved":True,"schema_sha256":H,"artifact_identity":"AVAILABLE","artifact_sha256":H,"artifact_manifest_identity":"AVAILABLE","artifact_manifest_sha256":H},"config":{"sha256":H},"evidence":{"request":"request.json","config":"config.json","model_schema":"model/config.schema.json","model_artifact":"model/model.json","model_manifest":"model/manifest.json","runner_set_sha256":H,"prediction_output_sha256":hashlib.sha256(canonical_bytes(rows)).hexdigest(),"protocol_chain":{"request_id":"request-1","request_sha256":H,"claim_sha256":H,"attempt_sha256":H,"response_sha256":H,"receipt_sha256":H,"consume_sha256":H,"authenticated_receipt_sha256":H},"authenticated_cutoff":{"history_seal_sha256":H,"cutoff_timestamp":"2026-08-01T01:00:00+00:00","source_sha256":H,"sealed_sha256":H}},"prediction":{"predictions":rows}})
