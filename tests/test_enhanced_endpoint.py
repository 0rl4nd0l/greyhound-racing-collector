            ...
            with app.test_request_context(
                ...
                if isinstance(response_data, dict):
                    ...
                    if response_data.get("success"):
                        print(
                            f"   📈 Predictor used: {response_data.get('predictor_used', 'unknown')}"
                        )
                        ...
                        if predictions:
                            ...
                            print(
                                f"   🏆 Top pick: {top_pick.get('dog_name', 'unknown')} (Score: {top_pick.get('final_score', 0):.3f})"
                            )
                    else:
                        print(
                        ...
                        print(
                            f"   🔍 Error type: {response_data.get('error_type', 'unknown')}"
                        )
                else:
