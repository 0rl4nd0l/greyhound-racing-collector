...
def run_key_consistency_tests():
    ...
    test_categories = [
        ...
        },
        {
            ...
            "tests": ["test_error_handling_and_fallback_logic"],
        },
        {
            "name": "Full Integration Tests",
            "tests": ["test_integration_all_layers_consistent_keys"],
        },
    ]
    ...
    for category in test_categories:
        ...
        category_results = {"passed": 0, "failed": 0, "errors": []}
        ...
        print(
            f"Category Summary: {category_results['passed']} passed, {category_results['failed']} failed"
        )
    ...
    if results["summary"]["failed"] == 0:
        ...
        if results["summary"]["key_errors_detected"] > 0:
            print(
                f"🚨 CRITICAL: {results['summary']['key_errors_detected']} KeyErrors detected!"
            )
            print(
