...
class MockCSVProcessor:
    ...
    def process_upcoming_races_csv(self, page=1, per_page=10, sort_by="race_date", order="desc", search=""):
...
Dummy Dog Beta,2,29.5,Dummy Trainer B'''
    ...
    def test_requirement_1_temp_dir_three_csvs_correct_count(self, three_dummy_csvs):
        ...
        assert len(result['races']) == 3, f"Should return exactly 3 races, got {len(result['races'])}"
        assert result['pagination']['total_count'] == 3, f"Total count should be 3, got {result['pagination']['total_count']}"
        
        print("✅ REQUIREMENT 1 PASSED: Correct count (3) returned for three dummy CSV files")
    ...
    def test_requirement_2_correct_structure_validation(self, three_dummy_csvs):
        ...
        required_fields = ['success', 'races', 'pagination', 'sort_by', 'order', 'search']
    ...
    def test_requirement_5_search_functionality(self, three_dummy_csvs):
        ...
        assert len(result['races']) == 1, "Search for 'Dummy Race Two' should return 1 race"
        ...
        assert len(result['races']) == 0, "Search for non-existent term should return 0 races"
    ...
    def test_requirement_7_race_id_consistency(self, three_dummy_csvs):
        ...
        for race in races1:
            ...
            assert race['race_id'] == expected_race_id, f"Race ID should be MD5 hash for {race['filename']}"
