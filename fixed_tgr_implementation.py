...
def test_fixed_implementation():
    ...
    scraper._fetch_race_details = create_fixed_fetch_race_details().__get__(scraper, type(scraper))
    scraper._extract_dog_racing_history = create_extract_dog_racing_history().__get__(scraper, type(scraper))
    scraper._extract_dog_entries = create_fixed_extract_dog_entries().__get__(scraper, type(scraper))
