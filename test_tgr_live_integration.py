    ...
    try:
        ...
        if temporal_builder:
            ...
            if tgr_integrator:
                ...
                print(f"   🏷️  TGR features available: {len(tgr_integrator.get_feature_names())}")
            else:
        ...
        try:
            ...
            if temporal_builder:
                features = temporal_builder.build_features_for_race(df, "test_race_tgr_live")
                print(f"   ✅ Generated {len(features)} feature rows")
                if not features.empty:
                    tgr_features = [col for col in features.columns if col.startswith('tgr_')]
                ...
                print(f"   ❌ Cannot test feature generation - temporal builder not available")
