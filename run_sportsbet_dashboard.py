...
def launch_dashboard():
    ...
    dashboard_path = Path("archive_unused_scripts/standalone_tools/live_odds_dashboard.py")
    ...
    if not check_streamlit():
        ...
        if response in ['y', 'yes']:
            if not install_streamlit():
                print("❌ Installation failed. Please install manually: pip install streamlit")
                return
