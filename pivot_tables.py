...
pivot_log_data = data.pivot_table(
    ...
    aggfunc=lambda x: 1 - x.mean()  # Percentage of missing data is 1 - percentage of present data
) * 100
...
print("Percentage of races with missing log data by track vs. quarter", pivot_log_data, sep="\n")
