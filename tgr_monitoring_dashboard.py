...
class TGRMonitoringDashboard:
    ...
    def _assess_data_quality(self) -> Dict[str, Any]:
        ...
        try:
            ...
            completeness_score = (complete_profiles / total_dogs * 100) if total_dogs > 0 else 0
            ...
            consistency_score = ((valid_wins + valid_consistency) / (2 * total) * 100) if total > 0 else 0
            ...
            quality['overall_score'] = (completeness_score + freshness_score + consistency_score) / 3
    ...
    def _calculate_performance_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if collection_stats and collection_stats[0] > 0:
                total_collections, avg_entries, avg_comments, avg_time = collection_stats
        ...
        try:
            ...
            efficiency = {
                ...
                'storage': {
                    ...
                    'estimated_total_size_mb': (total * (avg_size or 0)) / (1024 * 1024) if total and avg_size else 0
                },
                'temporal': {
                    'oldest_entry': oldest,
                    'newest_entry': newest,
            ...
            cache_generation_rate = (recent_cache_entries / recent_collections) if recent_collections > 0 else 0
    ...
    def _analyze_collection_trends(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'this_week' in trends['weekly_comparison'] and 'last_week' in trends['weekly_comparison']:
                this_week = trends['weekly_comparison']['this_week']
                last_week = trends['weekly_comparison']['last_week']
                
                trends['week_over_week'] = {
                    'collections_change': this_week['collections'] - last_week['collections'],
                    'entries_change': this_week['avg_entries'] - last_week['avg_entries'],
                    'success_rate_change': this_week['success_rate'] - last_week['success_rate']
                }
    ...
    def print_dashboard(self):
        ...
        if 'completeness' in quality:
            ...
            print(f"   Completeness: {comp.get('complete_profiles', 0)}/{comp.get('total_dogs', 0)} dogs")
        ...
        if recommendations:
            ...
            for rec in recommendations[:2]:  # Show top 2 recommendations
                ...
                print(f"   {priority_emoji} {rec.get('message', 'Unknown recommendation')}")
