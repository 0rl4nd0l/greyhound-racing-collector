...
class EnhancedPipelineV2:
    """Enhanced Pipeline v2 - wrapper for compatibility"""
...
class EnhancedComprehensiveProcessor:
    ...
    def process_csv_file(self, csv_file_path: str) -> Dict[str, Any]:
        ...
        try:
            # Read CSV file (form guide data) with enhanced format support
            # Handle pipe-delimited files with line numbers
            with open(csv_file_path, "r", encoding="utf-8") as f:
                ...
                if "|" in first_line:
                    ...
                    if len(parts) >= 2 and parts[0].strip().isdigit():
                        ...
                        print(f"   🔢 Detected line numbers at start of each row")
            ...
            if has_line_numbers and delimiter == "|":
                ...
                print(
                    f"   🛠️ Using special parsing for pipe-delimited file with line numbers"
                )
        ...
        try:
            ...
            for selector in expert_selectors:
                ...
                for table in tables:
                    ...
                    if any(
                        "speed" in header or "rating" in header for header in headers
                    ):
