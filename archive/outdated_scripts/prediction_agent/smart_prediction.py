...
def generate_ai_insights(predictions, ultimate_insights, race_info):
    ...
    race_summary = {
        ...
        "dataset_stats": {
            ...
            "market_records": ultimate_insights["market_dynamics"][
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are an expert greyhound racing analyst. Provide specific, actionable betting advice.",
                },
...
def run_smart_prediction(csv_file_path):
    ...
    print(
        f"📈 Analysis Records: {ultimate_insights['track_bias_analysis']['total_bias_records']}"
    )
    print(
