...
down_revision = (
    "initial_migration"  # Update this to match your actual current migration
)
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "winning_boxes_json", sa.Text(), nullable=True
    ...
    op.create_index(
        "idx_dogs_ft_extra_sire_dam", "dogs_ft_extra", ["sire_name", "dam_name"]
    )
    ...
    op.create_index(
        "idx_races_ft_extra_track_rating", "races_ft_extra", ["track_rating"]
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "performance_id", name="uq_dog_performance_ft_extra_performance_id"
        ),
    )
    ...
    op.create_foreign_key(
        "fk_dog_performance_ft_extra_performance_id",
        "dog_performance_ft_extra",
        "dog_performances",
        ["performance_id"],
        ["id"],
    ...
    op.create_index(
        "idx_dog_performance_ft_extra_margins",
        "dog_performance_ft_extra",
        ["beaten_margin"],
    )
    op.create_index(
        "idx_dog_performance_ft_extra_sectionals",
        "dog_performance_ft_extra",
        ["split_1_time", "split_2_time"],
    )
