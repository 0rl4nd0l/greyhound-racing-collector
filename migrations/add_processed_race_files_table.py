...
def migrate_database(db_path):
    ...
    try:
        ...
        cursor.execute(
            "CREATE INDEX idx_processed_files_hash ON processed_race_files(file_hash)"
        )
        cursor.execute(
            "CREATE INDEX idx_processed_files_race_key ON processed_race_files(race_date, venue, race_no)"
        )
        cursor.execute(
            "CREATE INDEX idx_processed_files_processed_at ON processed_race_files(processed_at)"
        )
