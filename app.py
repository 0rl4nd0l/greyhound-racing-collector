    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print(f"🔍 Running integrated prediction analysis for historical race {race_id}...")
                prediction_result = integrated_system.unified_predictor.predict_race_file(temp_race_file, enhancement_level='weather')
