    ...
    def _initialize_systems(self):
        ...
        try:
            ...
            if advanced_model_dir.exists():
                ...
                if model_files:
                    ...
                    self.advanced_ensemble_system = AdvancedEnsembleMLSystem(
                        self.db_path
                    )
        ...
        try:
            ...
            if not self.base_ml_system.pipeline:
                logger.warning(
                    "Base ML system has no trained model. Training one now..."
                )
    ...
    def _create_betting_optimizer(self, betting_strategy=None):
        ...
        if betting_strategy:
            ...
            if "confidence_threshold" in betting_strategy:
                optimizer.confidence_threshold = betting_strategy[
    ...
    def get_system_status(self):
        ...
        return {
            ...
            "advanced_ensemble_status": {
                ...
                "model_info": (
                    self.advanced_ensemble_system.get_model_info()
                    if self.advanced_ensemble_system
                    else None
                ),
            },
            "base_ml_system_status": {
                ...
                "model_info": (
                    self.base_ml_system.get_model_info()
                    if self.base_ml_system
                    else None
                ),
            },
        }
    ...
    def _error_response(self, error_message):
        ...
        return {
            ...
            "prediction": {
                "win_probability": 0,
                "confidence": 0,
                "betting_recommendation": {"has_value": False, "bet_type": "NO_BET"},
            },
        }
...
def run_comprehensive_prediction_analysis():
    ...
    strategy_results = orchestrator.compare_betting_strategies(
        test_dog, market_odds, strategies
    )
