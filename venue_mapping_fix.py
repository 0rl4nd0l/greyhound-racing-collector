...
class GreyhoundVenueMapper:
    def __init__(self):
        ...
        self.venue_mappings = {
            ...
            "CASO": {
                "official_name": "Casino",
                "codes": ["CASO", "caso", "CASINO"],
                "track_codes": ["CASO"],
                "location": "NSW",
                "active": True,
            },
            ...
            "QLD_STRAIGHT": {
                ...
                "track_codes": [
                    ...
                    "QOT",
                    "QTT",
                ],  # These are the historical track codes!
                "location": "QLD",
                "active": True,
    ...
    def resolve_venue(self, venue_input: str) -> Optional[str]:
        ...
        for venue_key, venue_info in self.venue_mappings.items():
            for code in venue_info["codes"]:
                if (
                    code.upper() in venue_clean.upper()
                    or venue_clean.upper() in code.upper()
                ):
                    return venue_key
    ...
    def fix_database_venue_mappings(self, db_path: str = "greyhound_racing_data.db"):
        ...
        try:
            ...
            cursor.execute(
                "SELECT DISTINCT venue, COUNT(*) FROM race_metadata GROUP BY venue"
            )
    ...
    def test_venue_resolution(self):
        ...
        for test_input in test_cases:
            ...
            if resolved:
                ...
                print(
                    f"✅ {test_input:20} → {resolved:15} ({venue_info['official_name']}, tracks: {track_codes})"
                )
            else:
