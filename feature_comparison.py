...
for metadata_file in metadata_files:
    ...
    print(
        f"Features missing in engineered list from {metadata_file}: {drift_check['missing_features']}"
    )
    print(
        f"Extra features present in engineered list not in model from {metadata_file}: {drift_check['extra_features']}"
    )
