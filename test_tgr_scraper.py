...
try:
    ...
    def test_tgr_scraper():
        ...
        if race_data.get("dogs"):
            ...
            logger.info(
                f"   • Racing history entries: {sample_dog.get('total_races', 0)}"
            )
            ...
            if sample_dog.get("racing_history"):
                ...
                enhanced_entries = scraper._extract_dog_entries(
                    race_data, sample_dog["dog_name"]
                )
                ...
                if enhanced_entries:
                    ...
                    logger.info(
                        f"   • Sample enhanced entry keys: {list(sample_enhanced.keys())}"
                    )
