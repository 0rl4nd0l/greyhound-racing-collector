...
def validate_and_convert_data_types(df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    numeric_columns = [
        'place', 'box_number', 'weight_kg', 'distance_m', 'race_time',
        'winning_time', 'bonus_points', 'first_section_time', 'margin',
        'performance_index_rating', 'starting_price', 'second_section_time',
        'third_section_time'
    ]
...
def handle_missing_values(df: pd.DataFrame) -> pd.DataFrame:
    ...
    numeric_cols = ['weight_kg', 'distance_m', 'race_time', 'winning_time', 
                   'bonus_points', 'first_section_time', 'margin',
                   'performance_index_rating', 'starting_price']
    ...
    try:
        ...
        for dog_name, dog_df in dog_records.items():
            stats = {
                ...
                'avg_weight': dog_df['weight_kg'].mean() if 'weight_kg' in dog_df else None,
                'avg_race_time': dog_df['race_time'].mean() if 'race_time' in dog_df else None,
                'best_place': dog_df['place'].min() if 'place' in dog_df else None,
                'avg_starting_price': dog_df['starting_price'].mean() if 'starting_price' in dog_df else None
            }
