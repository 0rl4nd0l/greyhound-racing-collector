...
class DatabaseInitializer:
    ...
    def create_schema(self):
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_entries_dog ON race_entries(dog_id)')
    ...
    def migrate_csv_data(self):
        ...
        logger.info(f"Migration completed. Processed {self.migration_stats['files_processed']} files")
    ...
    def generate_migration_report(self):
        ...
        # Get record counts
        counts = {}
        tables = ['venues', 'races', 'dogs', 'race_entries', 'form_guides', 'enhanced_analysis']
