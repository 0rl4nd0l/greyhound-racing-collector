...
# Directories to scan
dirs_to_scan = ['form_guides/downloaded', 'upcoming_races', 'processed', 'archive/corrupt_historical_race_data', 'historical_races']
...
def get_file_info(file_path):
    ...
    file_info['modified_date'] = datetime.fromtimestamp(os.path.getmtime(file_path)).strftime('%Y-%m-%d %H:%M:%S')
