...
if pivot_avg_time is not None and not pivot_avg_time.empty:
    ...
    plt.tight_layout()
    plt.savefig(
        "reports/figures/avg_race_time_by_track_vs_month.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
...
if pivot_race_count is not None and not pivot_race_count.empty:
    ...
    plt.tight_layout()
    plt.savefig(
        "reports/figures/race_count_by_day_vs_track.png", dpi=300, bbox_inches="tight"
    )
    plt.close()
...
if pivot_log_data is not None and not pivot_log_data.empty:
    ...
    plt.tight_layout()
    plt.savefig(
        "reports/figures/missing_log_data_by_track_vs_quarter.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
