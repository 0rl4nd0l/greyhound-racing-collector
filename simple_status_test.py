...
class UltraSimpleStatusTest:
    ...
    def process_csv_simple(self, filepath: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if "AP_K" in race_info["venue"] or "AP-K" in race_info["venue"]:
                ...
                race_info["winner_name"] = dogs[0]["dog_clean_name"] if dogs else "SIMULATED_WINNER"
    ...
    def save_to_database(self, race_info: Dict[str, Any], dogs: List[Dict[str, Any]]):
        ...
        try:
            ...
            conn.commit()
            print(f"✅ Saved race {race_info['race_id']} with status: {race_info.get('results_status')}")
...
def main():
    ...
    print("   - ✅ results_status field assignment (complete, partial_scraping_failed, pending)")
