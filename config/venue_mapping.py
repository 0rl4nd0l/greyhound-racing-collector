...
VENUE_STATE_MAPPING = {
    'DAPT': 'NSW', 'RICH': 'NSW', 'WPK': 'NSW', 'DUBBO': 'NSW', 'GOUL': 'NSW',
    'GOSFORD': 'NSW', 'NOWRA': 'NSW', 'MAITLAND': 'NSW', 'TAREE': 'NSW', 'GRAF': 'NSW',
    'MUSWELLBROOK': 'NSW', 'BH': 'NSW',
    'GRDN': 'VIC', 'GEE': 'VIC', 'HEA': 'VIC', 'BEN': 'VIC', 'BAL': 'VIC', 'SHEP': 'VIC',
    'WAR': 'VIC', 'WRGL': 'VIC', 'SAN': 'VIC', 'MEA': 'VIC', 'CRAN': 'VIC',
    'AP': 'QLD', 'AP_K': 'QLD', 'IPS': 'QLD', 'QOT': 'QLD', 'CAPA': 'QLD', 'ROCK': 'QLD',
    'TWN': 'QLD', 'CASO': 'NSW',  # Casino is actually in NSW
    'MURR': 'SA', 'APWE': 'SA', 'GAWL': 'SA', 'MT_G': 'SA',
    'CANN': 'WA', 'MAND': 'WA', 'NOR': 'WA',
    'HOBT': 'TAS', 'LAU': 'TAS', 'BRIGH': 'TAS',
    'TEM': 'NSW', 'WAG': 'NSW', 'SAL': 'VIC', 'DARW': 'NT', 'GUNN': 'NSW',
    'HOR': 'VIC', 'MBS': 'NSW', 'TRA': 'VIC', 'WOL': 'VIC',
}
