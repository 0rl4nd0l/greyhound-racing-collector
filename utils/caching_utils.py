...
def get_processed_filenames(directory: str, database_path: str = "./databases/greyhound_racing.db") -> Set[str]:
...
def ensure_processed_files_table(database_path: str = "./databases/greyhound_racing.db") -> bool:
