...
class ExtendedIntegrityChecker:
    ...
    def analyze_trainer_consistency(self):
        ...
        trainers_performance = self.execute_query(
            query1, "Trainers in dog_performances"
        )
    ...
    def analyze_seasonal_consistency(self):
        ...
        multi_year_dogs = self.execute_query(
            query3, "Dogs active across multiple years"
        )
    ...
    def analyze_form_guide_integrity(self):
        ...
        overlapping_data = self.execute_query(
            query2, "Overlapping form guide and performance data"
        )
    ...
    def analyze_box_number_consistency(self):
        ...
        duplicate_boxes = self.execute_query(
            query3, "Duplicate box numbers in same race"
        )
    ...
    def generate_detailed_recommendations(self):
        ...
        form_dogs_missing = (
            self.results.get("form_guide_analysis", {})
            .get("completeness", {})
            .get("unique_dogs", 0)
        )
        ...
        missing_trainers = (
            self.results.get("trainer_analysis", {})
            .get("missing_trainer_stats", {})
    ...
    def run_extended_analysis(self):
        ...
        venue_count = self.execute_query("SELECT COUNT(*) as count FROM venues")[
            "count"
        ].iloc[0]
