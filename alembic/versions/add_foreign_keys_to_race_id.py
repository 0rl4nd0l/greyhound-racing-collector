...
def upgrade():
    ...
    with op.batch_alter_table('dog_race_data') as batch_op:
        batch_op.create_foreign_key('fk_dog_race_data_race_id', 'race_metadata', ['race_id'], ['race_id'], ondelete="CASCADE")

    with op.batch_alter_table('enhanced_expert_data') as batch_op:
        batch_op.create_foreign_key('fk_enhanced_expert_data_race_id', 'race_metadata', ['race_id'], ['race_id'], ondelete="CASCADE")
