...
class EnhancedDataProcessor:
    ...
    def process_comprehensive_json_files(self) -> Dict[str, Any]:
        ...
        if os.path.exists(self.json_data_dir):
            json_files = [f for f in os.listdir(self.json_data_dir) if f.endswith('_comprehensive.json')]
        ...
        for json_file in json_files:
            ...
            try:
                ...
                processing_result = self.process_single_comprehensive_data(comprehensive_data, json_file)
        ...
        results['success_rate'] = results['processed'] / len(json_files) * 100 if json_files else 0
    ...
    def process_single_comprehensive_data(self, comprehensive_data: Dict[str, Any], filename: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if performance_tables:
                perf_result = self.process_performance_tables(race_id, performance_tables)
            ...
            if additional_metrics:
                metrics_result = self.process_additional_metrics(race_id, additional_metrics, race_info)
    ...
    def process_enhanced_csv_data(self, race_id: str, csv_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def extract_enhanced_fields(self, race_id: str, row_dict: Dict[str, str]) -> Optional[Dict[str, Any]]:
    ...
    def process_sectional_data(self, race_id: str, sectional_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for table_key, table_data in sectional_data.items():
                ...
                for dog_data in dogs_data:
                    ...
                    sectional_record = self.extract_sectional_analysis(race_id, dog_data, headers)
    ...
    def extract_sectional_analysis(self, race_id: str, dog_data: Dict[str, str], headers: List[str]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            sectional_fields = {
                'first_section_time': ['first section', '1st section', '400m', 'first split'],
                'middle_section_time': ['middle section', 'mid section', '500m', '600m'],
    ...
    def process_performance_tables(self, race_id: str, performance_tables: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def process_additional_metrics(self, race_id: str, additional_metrics: Dict[str, Any], race_info: Dict[str, str]) -> Dict[str, Any]:
        ...
        try:
            ...
            track_metrics = {
                ...
                'weather_conditions': self.extract_weather_conditions(additional_metrics),
                'temperature': self.extract_temperature(additional_metrics),
                'extraction_timestamp': datetime.now().isoformat(),
                'data_completeness': self.calculate_data_completeness(additional_metrics)
            }
    ...
    def process_embedded_json_data(self, race_id: str, embedded_json: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def contains_performance_data(self, row: Dict[str, str], headers: List[str]) -> bool:
        """Check if row contains performance data"""
        performance_keywords = ['rating', 'speed', 'time', 'points', 'score']
        return any(keyword in ' '.join(headers).lower() for keyword in performance_keywords)
    
    def update_performance_metrics(self, race_id: str, row: Dict[str, str], headers: List[str]):
    ...
    def extract_temperature(self, additional_metrics: Dict[str, Any]) -> Optional[float]:
    ...
    def extract_feature_vector(self, embedded_json: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def extract_prediction_inputs(self, embedded_json: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def generate_processing_report(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Save report
            report_path = os.path.join(self.enhanced_data_dir, f"processing_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json")
