                ...
                if elements and len(elements) > 2:
                    ...
                    for i, elem in enumerate(elements[:5]):
                        try:
                            ...
                            if ('race' in text.lower() or 'r1' in text.lower() or 'r2' in text.lower()) and len(text) > 20:
            ...
            try:
                ...
                for elem in elements:
                    try:
                        ...
                        if ('r1' in text.lower() or 'r2' in text.lower() or 'race' in text.lower()) and len(text) < 50:
