...
def demonstrate_schema_validation():
    ...
    try:
        ...
        for level in levels:
            ...
            required_cols = ingestor.required_columns_by_level[ingestor.validation_level]
            ...
            if csv_files:
                ...
                if validation_result.is_valid:
                    ...
                    if processed_data:
                        ...
                        print(f"   🔗 Sample record dog_name: '{sample_record.get('dog_name', 'MISSING')}'")
                        ...
                        if 'dog_name' in sample_record:
                            print("   ✅ CRITICAL: 'Dog Name' successfully mapped to 'dog_name'")
                        else:
...
def demonstrate_integration_benefits():
    ...
    try:
        ...
        print("   ✅ Flexible validation levels (strict/moderate/lenient) for different use cases")
        print("   ✅ Automatic fallback to legacy system ensures reliability")
        print("   ✅ Handles greyhound form guide format (blank rows belong to dog above)")
