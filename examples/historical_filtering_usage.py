...
def example_file_filtering_logic():
    ...
    filename_examples = [
        ...
        ("general_race.csv", "📝 DEPENDS", "No date in filename - checks file content/mtime"),
    ]
...
def main():
    ...
    print("✅ SUMMARY")
    print("=" * 60)
    print("The --historical flag enables filtering to process only races with dates < today.")
    print("This prevents data leakage and ensures clean separation of historical vs future data.")
    print()
    print("Key benefits:")
