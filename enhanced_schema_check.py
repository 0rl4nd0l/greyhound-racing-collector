...
def connect_db():
    ...
    return sqlite3.connect(
        "/Users/orlandolee/greyhound_racing_collector/databases/race_data.db"
    )
...
def analyze_races_table(conn):
    ...
    # Range checks
    range_checks = {"distance": (300, 800)}  # Race distances 300m to 800m
...
def generate_comprehensive_report(all_results):
    ...
    with open(report_path, "w") as f:
        ...
        f.write(
            f"- **Data Quality Status:** {'PASS' if total_violations == 0 else 'FAIL'}\n\n"
        )
