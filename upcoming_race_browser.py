...
class UpcomingRaceBrowser:
    ...
    def extract_race_info_from_link(
        self, link_element, href, date_str, *, meeting_card_sha256=None
    ):
    ...
    def _extract_exact_meeting_card_grade(
        ...
        *,
        ...
        if source_url is None:
            return {}
        source_sha256 = str(meeting_card_sha256 or "").strip().lower()
            ...
            if linked_identities == {identity["canonical_url"]}:
                ...
                if len(distinct_keys) == 1:
                    ...
                    return {
                        ...
                        "target_grade_source_sha256": source_sha256,
    ...
    def _extract_safe_target_grade_from_hint(self, race_info_hint, race_url):
        ...
        source_sha256 = str(
            race_info_hint.get("target_grade_source_sha256") or ""
        ).strip().lower()
        if (
            expected is None
            or hinted is None
