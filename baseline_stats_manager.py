...
class BaselineStatsManager:
    ...
    def __init__(
        ...
        logger.info(
            f"📊 Baseline Stats Manager initialized for version: {self.model_version}"
        )
    ...
    def get_monitored_features(self) -> List[str]:
        ...
        """
        return ["weight", "box_number", "distance"]
    ...
    def get_feature_baseline(
        self, feature_name: str, model_version: Optional[str] = None
    ) -> Optional[Dict[str, Any]]:
    ...
    def compare_versions(self, version1: str, version2: str) -> Dict[str, Any]:
        ...
        comparison = {"version1": version1, "version2": version2, "feature_changes": {}}

        # Compare features that exist in both versions
        common_features = set(stats1.get("features", {}).keys()) & set(
            stats2.get("features", {}).keys()
        )
